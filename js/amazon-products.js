...
let AMAZON_PRODUCTS = [
  ...
  { asin: 'https://partner.pcloud.com/affiliate/create', title: 'pCloud Affiliate', desc: 'Join the pCloud affiliate program and earn recurring commissions.', badge: 'Affiliate', btnClass: 'btn-primary', img: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=400&auto=format&fit=crop' },
  { asin: 'https://www.pcloud.com/', title: 'pCloud Storage', desc: 'Secure European cloud storage. The safest place for your digitized memories.', badge: 'Storage', btnClass: 'btn-primary', img: 'https://images.unsplash.com/photo-1544816155-12df9643f363?q=80&w=400&auto=format&fit=crop' },
  { asin: 'https://partner.pcloud.com/dl/mac', title: 'pCloud Drive (Mac)', desc: 'Direct download for the pCloud desktop app on Mac to sync photos.', badge: 'Desktop', btnClass: 'btn-secondary', img: 'https://images.unsplash.com/photo-1517059224940-d4af9eec41b7?q=80&w=400&auto=format&fit=crop' },
  { asin: 'https://www.pcloud.com/pass', title: 'pCloud Pass', desc: 'Securely manage your passwords and sensitive data with end-to-end encryption.', badge: 'Passwords', btnClass: 'btn-secondary', img: 'https://images.unsplash.com/photo-1614064641913-6b71a30611bf?q=80&w=400&auto=format&fit=crop' },
  { asin: 'https://www.pcloud.com/Europe', title: 'pCloud Europe', desc: 'Cloud storage fully compliant with strict European data privacy laws.', badge: 'Privacy', btnClass: 'btn-secondary', img: 'https://images.unsplash.com/photo-1453227588063-bb302b62f50b?q=80&w=400&auto=format&fit=crop' },
  { asin: 'https://www.pcloud.com/family', title: 'pCloud Family Plan', desc: 'Share 2TB of lifetime storage with up to 5 family members for all your photos.', badge: 'Family', btnClass: 'btn-primary', img: 'https://images.unsplash.com/photo-1511895426328-dc8714191300?q=80&w=400&auto=format&fit=crop' },
